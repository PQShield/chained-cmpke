...
// Group is simply the seed of G.
#define MKEM_GROUPBYTES MKEM_SYMBYTES

// Short element plus kem seed
#define MKEM_SECRETKEYBYTES (190 + MKEM_SYMBYTES)

// Rounded element
#define MKEM_PUBLICKEYBYTES 1076

#define MKEM_SSBYTES MKEM_SYMBYTES

// Rounded element
#define MKEM_CTIBYTES 1076

// I-tuple from ℤ/τ.
#define MKEM_CTDBYTES 32
